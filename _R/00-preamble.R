...
dirs$raxml_boot <- paste0(dirs$parent, "/phylo/chir_raxml_boot")
dirs$mcmctree <- paste0(dirs$parent, "/phylo/chir_mcmctree")
dirs$cafe <- paste0(dirs$parent, "/ortho-analyses/chir_cafe")
dirs$orthofinder <- paste0(dirs$parent, "/ortho-analyses/chir_orthofinder/orthofinder-output")
dirs$orthofinder_extr <- paste0(dirs$parent, "/ortho-analyses/orthofinder-extraction")
dirs$hyphy_busted <- paste0(dirs$parent, "/ortho-analyses/chir_hyphy_busted")
dirs$hyphy_relax <- paste0(dirs$parent, "/ortho-analyses/chir_hyphy_relax")
